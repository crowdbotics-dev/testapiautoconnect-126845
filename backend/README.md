...
## Project Structure
    ...
    ├── testapiautoconnect_126845  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_126845`
...
2. Clone this repo and `cd testapiautoconnect_126845`
